...
import { Calculator, LineChart, Table2, Sigma, PanelLeft, Power } from "lucide-react";
  ...
  return (
    <header className="flex items-center gap-3 px-3 py-1.5 border-b border-border bg-[var(--gradient-header)]">
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-[0.6rem] tracking-[0.25em] text-muted-foreground">v0.1 / CYBERLAB</span>
      </div>
      ...
      <div className="ml-auto flex items-center gap-3">
        ...
        <div className="text-[0.65rem] tracking-[0.25em] text-muted-foreground tabular-nums">
