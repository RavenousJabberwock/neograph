...
import { FolderOpen, Save, FilePlus2, X, Calculator, LineChart, Table2, Sigma } from "lucide-react";
import { useState } from "react";

const STORAGE_KEY = "lvbl_calc_workspaces_v1";

interface Workspace {
  name: string;
  data: {
    plots: ReturnType<typeof JSON.parse> extends infer T ? T : never;
...
export function WorkspaceSidebar() {
  ...
  return (
    <div className="panel h-full">
      ...
      <div className="panel-body p-3 flex flex-col gap-3 text-[0.75rem]">
        <div>
          <div className="text-[0.6rem] tracking-widest text-muted-foreground mb-1">NAME</div>
        ...
        <div>
          <div className="text-[0.6rem] tracking-widest text-muted-foreground mb-1.5">SAVED</div>
        ...
        <div className="border-t border-border pt-3">
          <div className="text-[0.6rem] tracking-widest text-muted-foreground mb-1.5">PANELS</div>
          <div className="space-y-1">
            {panelList.map((p) => (
